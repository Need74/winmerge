...
ThreeWayMergeWizardPageDescription=Utilisez-vous WinMerge comme un outil de merge (fusion) à 3-voies pour TortoiseSVN/Git ?
RegisterWinMergeAs3WayMergeTool=Enregistrer WinMerge comme outils de merge (fusion) à 3-voies
...
ExplorerNeedsRestart=WinMerge ShellExtension (menu contextuel) nécessite un redémarrage de l'Explorateur pour se mettre à jour. Souhaitez-vous redémarrer l'Explorateur ?
