...
ExplorerNeedsRestart='L'extension du Shell' de WinMerge nécessite un redémarrage de l'Explorateur pour se mettre à jour. Souhaitez-vous redémarrer l'Explorateur ?
